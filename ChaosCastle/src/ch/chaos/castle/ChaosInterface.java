        ...
        if (fileName != null) {
            ...
            if (chaosBase.file != files.noFile) {
                ...
                if (id.get() != ID) {
                    ...
                    LoadGame_RangeChk(chaosBase.level[Zone.Castle.ordinal()], 1, 
                            (Levels.ENABLE_NEW_LEVELS ? 30 : 20), ok);
                    LoadGame_RangeChk(chaosBase.level[Zone.Family.ordinal()], 1, 
                            (Levels.ENABLE_NEW_LEVELS ? 10 : 38), ok);
