...
import static ch.chaos.library.graphics.xbrz.Color.getAlpha;
import static ch.chaos.library.graphics.xbrz.Color.getBlue;
import static ch.chaos.library.graphics.xbrz.Color.getGreen;
import static ch.chaos.library.graphics.xbrz.Color.getRed;
import static ch.chaos.library.graphics.xbrz.Color.makePixel;
import static ch.chaos.library.graphics.xbrz.ColorGradient.gradientARGB;
import static ch.chaos.library.graphics.xbrz.ColorGradient.gradientRGB;
...
//    private static int calcColor(int M, int N, int colFront, int colBack) { // Unused
//        // Modified to not blend, because we stay in an indexed image:
//    	return (M * 2 < N ? colBack : colFront);
//    	
//    	// Original code:
