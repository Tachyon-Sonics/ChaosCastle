...
import static ch.chaos.library.graphics.xbrz.BlendInfo.addBottomL;
import static ch.chaos.library.graphics.xbrz.BlendInfo.addBottomR;
import static ch.chaos.library.graphics.xbrz.BlendInfo.addTopR;
import static ch.chaos.library.graphics.xbrz.BlendInfo.clearAddTopL;
import static ch.chaos.library.graphics.xbrz.BlendType.BLEND_DOMINANT;
import static ch.chaos.library.graphics.xbrz.BlendType.BLEND_NONE;
import static ch.chaos.library.graphics.xbrz.BlendType.BLEND_NORMAL;
import static ch.chaos.library.graphics.xbrz.RotationDegree.ROT_0;
import static ch.chaos.library.graphics.xbrz.RotationDegree.ROT_180;
import static ch.chaos.library.graphics.xbrz.RotationDegree.ROT_270;
import static ch.chaos.library.graphics.xbrz.RotationDegree.ROT_90;
